          ...
          <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div class="hidden sm:block sm:ml-6">
              <div class="flex space-x-4">
                ...
                <a href="/mapage" class="px-3 py-2 rounded-md text-sm font-medium text-gray-300 hover:text-white hover:bg-gray-700">Ma page</a>
                <a href="/classes" class="px-3 py-2 rounded-md text-sm font-medium text-gray-300 hover:text-white hover:bg-gray-700">Classes</a>
                <a href="/eleves" class="px-3 py-2 rounded-md text-sm font-medium text-gray-300 hover:text-white hover:bg-gray-700">Eleves</a>
              </div>
            </div>
          </div>
